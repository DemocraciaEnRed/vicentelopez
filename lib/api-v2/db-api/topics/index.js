...
exports.list = function list (opts) {
  ...
  if (opts.search) query.mediaTitle  = { $regex : `.*${opts.search}.*`, $options : 'i' }
 ...
 * @return {promise}
 */
exports.listCount = function listCount (forumId, searchString) {
  const query = { forum: forumId }

  if (searchString) query.mediaTitle  = { $regex : `.*${searchString}.*`, $options : 'i' }
