...
import ContenidoPortada from '../settings-contenido-portada/view'
...
const isValid = (ctx, next) => {
  ...
  if (user.staff) {
    ...
    valid.push(urlBuilder.for('settings.contenido-portada'))
  }
...
page([
  ...
  urlBuilder.for('settings.contenido-portada')
  ...
  if (user.staff) {
    ...
    contenidoPortada.appendTo(content)
  }
