// DOM traversal, manipulation and events aggregate library (like jQuery) - https://github.com/component/dom
...
export default class View extends Stateful {
  ...
  build () {
    ...
    // npm install inserted - invoke a callback when a DOM element is inserted - @tootallnate
  ...
  _oninsert () {
    ...
    // npm install removed - invoke a callback when a DOM element is removed - @tootallnate
