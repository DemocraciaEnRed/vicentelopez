...
export default class BtnFacebook extends Component {
  ...
  render () {
    ...
    return (
      <button
        className='btn btn-block btn-facebook disabled'
        onClick={()=>alert('Momentáneamente el inicio de sesión con Facebook no está disponible.\n¡Muy pronto volverá a estarlo!')}
        type='submit'>
