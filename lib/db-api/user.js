...
exports.expose.downloadbleAdmin = function downloadbleAdmin (user) {
  return expose(exports.expose.downloadbleAdmin.keys)(user)
}

exports.expose.downloadbleAdmin.keys = [
  'firstName',
  'lastName',
  'email',
]
