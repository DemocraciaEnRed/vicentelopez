            ...
            (
              <div className='alert alert-info alert-propuesta' role='alert'>
                ...
                {topic.attrs['admin-comment-referencia'] && topic.attrs['admin-comment-referencia'] !== '' &&
                  <p className='admin-comment-referido'>Puede ver 
                  {topic.attrs.state == 'integrado' ? 'el proyecto' : 'la propuesta' }
                  final <a className='admin-comment-referido' href={topic.attrs['admin-comment-referencia']}>aquí</a>.</p>
                }
