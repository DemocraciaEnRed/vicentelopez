...
export default class Carrusel extends Component {
  ...
  componentDidMount () {
    window.fetch(`/ext/api/topics?forumName=proyectos&anio=2019&state=preparacion,compra,ejecucion,finalizado&limit=20&sort=popular`, { credentials: 'include' })
      .then((res) => res.json())
      .then((res) => {
    ...
    return (
      <div className='seccion-proyectos container-fluid'>
        <div className="fondo-titulo">
          <h2 className='title'>Proyectos ganadores del 2018</h2>
        </div>
        <div ref='carrusel'>
