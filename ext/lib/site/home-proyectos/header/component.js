...
export default ({ stage }) => (
  <header className='banner-proyectos'>
    ...
    {/* -- Se oculta momentáneamente -- (27/08/19)
    ...
    <h1 className='proyectos-title'>Ocultamos la vista por el momento</h1>
    <h2 className='proyectos-subtitle'>Estamos trabajando en estos momentos. Falta poco para que publiquemos los proyectos a votación</h2>
  </header>
)
