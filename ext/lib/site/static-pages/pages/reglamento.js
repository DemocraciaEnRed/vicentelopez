      ...
      <div>
        ...
        <Anchor id='container'>
          <div className='ext-reglamento'>
            ...
            <p><strong>Art 5° CANALES DE PRESENTACIÓN DE LAS PROPUESTAS:</strong><span> Todas las propuestas deberán ser cargadas en el sitio https://presupuestoparticipativo.vicentelopez.gob.ar, utilizando el formulario específico que allí se ofrece, entre el 19 de marzo y el 31 de mayo de 2020. Para ello, cada persona –a título individual o en representación de una entidad- deberá registrarse como usuario del sitio utilizando un correo electrónico y una contraseña o ingresando con un usuario de la red social Facebook. Las propuestas deberán ser cargadas en el sitio arriba mencionado como condición para ser consideradas en el análisis de factibilidad. Este año, por razones de público conocimiento debido al coronavirus, hemos decidido suspender las reuniones presenciales de presentación de propuestas. Difundiremos y explicaremos el Programa de Presupuesto Participativo vía nuestra página web arriba mencionada, como así también en redes sociales, nuestras bases de correos electrónicos de vecinos y entidades, y contestaremos cualquier inquietud y preguntas en nuestra dirección de correo electrónico participación.ciudadana@vicentelopez.gov.ar y asistiremos a los vecinos presentadores de proyectos individuales o en representación de una entidad, atendiendo nuestro conmutador 4851-2000 opción 6, internos 203, 202, 201 y 200.</span></p>
