    ...
    <div className='ext-terminos-y-condiciones'>
      ...
      <div className='container'>
        <ul>
           ...
           <li><span>Pol&iacute;ticas de privacidad</span></li>
        </ul>
        <p><span></span></p>
        <p><span>El registro y uso en </span><span>forosvecinales.org </span><span>(en adelante,</span><span>&nbsp;Foros Vecinales</span><span>) indica la aceptaci&oacute;n de estos t&eacute;rminos y condiciones y de la pol&iacute;tica de privacidad.</span></p>
        <h2><span>Acerca de este sitio</span></h2>
        <p><span>Forosvecinales.org</span><span>&nbsp;es un nuevo canal de di&aacute;logo y deliberaci&oacute;n entre los los ciudadanos de Vicente L&oacute;pez y el gobierno municipal. Tiene como objetivos promover la participaci&oacute;n ciudadana y fortalecer el proceso de presupuesto participativo en el Municipio.</span></p>
        <h3><span>Tecnolog&iacute;a</span></h3>
        <p><span>Foros Vecinales</span><span>&nbsp;es un desarrollo basado en </span><span><a  href="https://www.google.com/url?q=http://democracyos.org/&amp;sa=D&amp;ust=1501267735218000&amp;usg=AFQjCNEv2LGzQpGHusHjn8OX0-t0AxCvKA">DemocracyOS</a></span><span>&nbsp;con la coordinaci&oacute;n de la Municipalidad de Vicente L&oacute;pez. DemocracyOS es una plataforma online de c&oacute;digo abierto especialmente dise&ntilde;ada para informar, debatir y votar propuestas p&uacute;blicas hacia la construcci&oacute;n de una democracia adaptada al siglo XXI. DemocracyOS es desarrollado por la Fundaci&oacute;n </span><span><a  href="https://www.google.com/url?q=http://democraciaenred.org&amp;sa=D&amp;ust=1501267735218000&amp;usg=AFQjCNEGSMRTyTyxvgeR79cbcxefZNyy6A">Democracia en Red</a></span><span>.</span></p>
        <h3><span>Registro en la plataforma web</span></h3>
        <p><span>El ingreso a </span><span>Foros Vecinales</span><span>&nbsp;no requiere registro online previo, el mismo ser&aacute; requerido si la/el usuaria/o desea publicar contenidos o interactuar con otros usuarios. </span></p>
        <p><span>Esperamos que te registres usando tu nombre. Las cuentas de &ldquo;bots&rdquo; u otros registros autom&aacute;ticos no est&aacute;n permitidas. Los usuarios son responsables de preservar la privacidad de su cuenta protegiendo el acceso a sus contrase&ntilde;as. Por favor, ante cualquier ingreso indebido en tu cuenta, comunicate inmediatamente a trav&eacute;s de participacion.ciudadana@vicentelopez.gov.ar</span></p>
        <h4><span>Validaci&oacute;n de usuarios</span></h4>
        <p><span>Foros Vecinales</span><span>&nbsp;se reserva el derecho de validar la informaci&oacute;n brindada por la/el usuaria/o al momento de la inscripci&oacute;n. En caso de que la informaci&oacute;n brindada no pueda validarse, </span><span>Foros Vecinales</span><span>&nbsp;se reserva el derecho de no dar de alta a ese usuario. Por su parte, </span><span>Foros Vecinales</span><span>&nbsp;deslinda su responsabilidad en el caso de no ser veraz la informaci&oacute;n suministrada al respecto.</span></p>
        ...
        <ul>
           ...
           <li><span>Los usuarios se comprometen a notificar a </span><span>Foros Vecinales</span><span>&nbsp;del uso no autorizado de su clave.</span></li>
           <li><span>Foros Vecinales </span><span>se reserva el derecho de rechazar cualquier solicitud de inscripci&oacute;n o de cancelar un registro previamente aceptado.</span></li>
        </ul>
        <h2><span>Usuarios, obligaciones y condiciones</span></h2>
        <p><span>La/El usuaria/o deber&aacute; respetar estos T&eacute;rminos y Condiciones de Uso. Las infracciones por acci&oacute;n u omisi&oacute;n de estos T&eacute;rminos y Condiciones de Uso generar&aacute;n el derecho a favor de </span><span>Foros Vecinales</span><span>&nbsp;de suspender al usuario que las haya realizado.</span></p>
        <p><span>La/El usuaria/o es responsable del contenido que suba, publique o muestre en Foros Vecinales, garantizando que el mismo no infringe derechos de terceros ni los T&eacute;rminos y Condiciones de Uso ni viola ninguna ley, reglamento u otra normativa. Los usuarios entienden y aceptan que el material y/o contenido que suba y/o publique podr&iacute;a ser utilizado por otros usuarios de la plataforma web y/o por terceras personas ajenas, y que </span><span>Foros Vecinales </span><span>no ser&aacute; responsable en ning&uacute;n caso por tales utilizaciones.</span></p>
        <p><span>La/El usuaria/o debe usar </span><span>Foros Vecinales </span><span>en forma correcta y l&iacute;cita. En caso contrario, </span><span>Foros Vecinales</span><span>&nbsp;podr&aacute; retirar el contenido y/o suspender la cuenta de aquellos usuarios que incurran en actitudes contrarias a estos t&eacute;rminos y condiciones y/o de la pol&iacute;tica de privacidad, ofensivas, ilegales, violatorias de derechos de terceros, contrarias a la moral y buenas costumbres y/o amenaza para la seguridad de otros usuarios.</span></p>
        ...
        <p><span>En caso de sufrir alguna de estas situaciones, comunicarse con Foros Vecinales a trav&eacute;s de participacion.ciudadana@vicentelopez.gov.ar.</span></p>
        <h4><span>Moderaci&oacute;n de la actividad en Foros Vecinales</span></h4>
        <p><span>La actividad en esta plataforma web contar&aacute; con moderadores responsables de hacer cumplir estos T&eacute;rminos y Condiciones de Uso. Los mismos ser&aacute;n designados por la Municipalidad de Vicente L&oacute;pez en pos de fomentar un di&aacute;logo franco y abierto que evite afrentas a personas o instituciones, material comercial no relacionado (SPAM) u otros desv&iacute;os de la intenci&oacute;n original de </span><span>Foros Vecinales</span><span>.</span></p>
        ...
        <p><span>La recolecci&oacute;n y tratamiento de los datos personales tiene como finalidad conocer sobre el uso de </span><span>Foros Vecinales</span><span>&nbsp;y mejorar la propuesta.</span></p>
        <p><span>La Municipalidad de Vicente L&oacute;pez no ceder&aacute; a ninguna otra persona ni organismo los datos personales de los participantes, salvo orden judicial en contrario. Los datos recabados tienen por &uacute;nico objeto verificar que los comentarios sean cursados por personas diferentes y evitar abusos en el uso de la plataforma. Esta informaci&oacute;n ser&aacute; utilizada exclusivamente para obtener estad&iacute;sticas generales de los usuarios.</span></p>
        <h4><span>Informaci&oacute;n proporcionada por los usuarios:</span></h4>
        <p><span>Las interacciones en </span><span>Foros Vecinales</span><span>&nbsp;requiere que los usuarios se registren. En ese caso, se solicitar&aacute; informaci&oacute;n personal, como nombre y apellido, documento, direcci&oacute;n de correo electr&oacute;nico. El perfil que es visible p&uacute;blicamente puede incluir el nombre y la foto seleccionada.</span></p>
        <p><span>Asimismo, si un usuario se pone en contacto con </span><span>Foros Vecinales</span><span>, es posible que guardemos constancia de la comunicaci&oacute;n para poder resolver m&aacute;s f&aacute;cilmente cualquier incidencia que se haya producido.</span></p>
