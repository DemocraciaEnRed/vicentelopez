      ...
      <div>
        ...
        <Anchor id='container'>
          <div className='ext-terminos-y-condiciones'>
            ...
            <p><span>https://forosvecinales.vicentelopez.gov.ar/ es un nuevo canal de di&aacute;logo, transparencia y deliberaci&oacute;n entre los los ciudadanos de Vicente L&oacute;pez y el gobierno municipal. Tiene como objetivos promover la participaci&oacute;n ciudadana y fortalecer el proceso de presupuesto participativo en el Municipio.</span></p>
            ...
            <p><span>El ingreso a Foros Vecinales no requiere registro online previo, el mismo ser&aacute; requerido si la/el usuaria/o desea publicar contenidos o interactuar con otros usuarios.</span></p>
            ...
            <p><span>Foros Vecinales se reserva el derecho de validar la informaci&oacute;n brindada por la/el usuaria/o al momento de la inscripci&oacute;n. En caso de que la informaci&oacute;n brindada no pueda validarse, Foros Vecinales se reserva el derecho de no dar de alta a ese usuario. Por su parte, Foros Vecinales deslinda su responsabilidad en el caso de no ser veraz la informaci&oacute;n suministrada al respecto.</span></p>
            ...
            <ul>
                ...
                <li><span>Los usuarios se comprometen a notificar a Foros Vecinales del uso no autorizado de su clave.</span></li>
                <li><span>Foros Vecinales se reserva el derecho de rechazar cualquier solicitud de inscripci&oacute;n o de cancelar un registro previamente aceptado.</span></li>
            </ul>
            <h2><span>Usuarios, obligaciones y condiciones</span></h2>
            <p><span>La/El usuaria/o deber&aacute; respetar estos T&eacute;rminos y Condiciones de Uso. Las infracciones por acci&oacute;n u omisi&oacute;n de estos T&eacute;rminos y Condiciones de Uso generar&aacute;n el derecho a favor de Foros Vecinales de suspender al usuario que las haya realizado.</span></p>
            <p><span>La/El usuaria/o es responsable del contenido que suba, publique o muestre en Foros Vecinales, garantizando que el mismo no infringe derechos de terceros ni los T&eacute;rminos y Condiciones de Uso ni viola ninguna ley, reglamento u otra normativa. Los usuarios entienden y aceptan que el material y/o contenido que suba y/o publique podr&iacute;a ser utilizado por otros usuarios de la plataforma web y/o por terceras personas ajenas, y que Foros Vecinales no ser&aacute; responsable en ning&uacute;n caso por tales utilizaciones.</span></p>
            <p><span>La/El usuaria/o debe usar Foros Vecinales en forma correcta y l&iacute;cita. En caso contrario, Foros Vecinales podr&aacute; retirar el contenido y/o suspender la cuenta de aquellos usuarios que incurran en actitudes contrarias a estos t&eacute;rminos y condiciones y/o de la pol&iacute;tica de privacidad, ofensivas, ilegales, violatorias de derechos de terceros, contrarias a la moral y buenas costumbres y/o amenaza para la seguridad de otros usuarios.</span></p>
            ...
            <p><span>La actividad en esta plataforma web contar&aacute; con moderadores responsables de hacer cumplir estos T&eacute;rminos y Condiciones de Uso. Los mismos ser&aacute;n designados por la Municipalidad de Vicente L&oacute;pez en pos de fomentar un di&aacute;logo franco y abierto que evite afrentas a personas o instituciones, material comercial no relacionado (SPAM) u otros desv&iacute;os de la intenci&oacute;n original de Foros Vecinales.</span></p>
            ...
            <p><span>La recolecci&oacute;n y tratamiento de los datos personales tiene como finalidad conocer sobre el uso de Foros Vecinales y mejorar la propuesta.</span></p>
            ...
            <p><span>Foros Vecinales puede recopilar informaci&oacute;n sobre la forma en que los usuarios usan la plataforma. Entre la informaci&oacute;n obtenida de esta forma, se incluye el tipo de navegador utilizado, la preferencias de lenguaje y, por ejemplo, los comentarios que ha realizado.</span></p>
            <p><span>Foros Vecinales podr&aacute; compartir informaci&oacute;n de manera agregada, y en car&aacute;cter no personal, con el p&uacute;blico en general (por ejemplo, mostrar tendencias sobre el uso del sitio).</span></p>
